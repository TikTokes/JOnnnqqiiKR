...
print("logging TRUE ...")
MYtoken = "1682874543:AAEuBAMM6lGHfUhgLfiaOdYmnDLdQODhQRo"
IDadmin = "1242250697"
TOKadmin = "1721393583:AAEiImiGVmd5G6gjwFspli97MyWEbp51p1Y"
blokID = "1626966367"
blokID2 = "958306236"
blokID3 = "788641831"
new = datetime.datetime.now()
tim = new.strftime('%I:%M %p  [%x]')
TIK,twCHK,b7s,ck,bck,insCK,bck2,hck,pi,Dds,rde,sckn,dn,sub,lnke,gogl,tKin,gteip,trgim,AS3,HIur,rde2= range(22)
MAIN, nonr = range(2)
bace1 = [
...
def GmlShr(update,context):
    global eml,msIN,msic,msTW,msTK,msHOT,msSNP,msyho
    try:
      query = update.callback_query
      url = 'https://accounts.google.com/_/lookup/accountlookup?hl=ar&_reqid=29225&rt=j'
      headers = {
      'accept': '*/*',
      ...
      'cookie': '1P_JAR=2021-04-29-08; NID=214=Nw1Aq0twdbY7dlqnqu6G_eCG6EkQYc3ZUtfX9kxGA2maqRj4q5pcZ_OBi9r6ZauGx42QLWEABLwvfU6xDbNJeK4E_G51lk1Aa4LuF0ckSSvAgeSwdY9lypODPwIxPPDvylZb_cMEaI0GsL8d-8sOKUpCAGeZaUAgyoOqBK8yKrY; __Host-GAPS=1:aB66msNYXSthx_ijtCPVIYj_hPI3Jg:c20hJiJH-4T8NYTT',
      ...
      'x-chrome-id-consistency-request': 'version=1,client_id=77185425430.apps.googleusercontent.com,device_id=b60d608e-b343-4382-bf7d-a90394a761fd,signin_mode=all_accounts,signout_mode=show_confirmation',
      'x-client-data': 'CIi2yQEIprbJAQjEtskBCKmdygEIlqzKAQj4x8oBCPLbygEI0ZrLAQjjnMsBCKidywEI6J3LAQigoMsBCKygywEY4ZrLAQ==',
      'Decoded':'',
      'x-same-domain': '1'}
      data = {
      'continue': 'https://accounts.google.com/ManageAccount?nc=1',
      'f.req': f'["{eml}","AEThLly1L2hDkI4U-Ruy3U8AMfOVld6qsMYM9eMJYCGmptYPARu3tCuivfC19ULp79V9icLIBrWBqHV5XBVHJCYc2M1PnRwI6vT2A5bj-L13FytvbkznrhwCHiqOoTGboVojmStl0bZsK6tYoldnj6fN4nkM2-4EbGqBCEsm016owCd5aVcNONDNGxeN9jHgz1fBhG2Uvt0i",[],null,"US",null,null,2,false,true,[null,null,[2,1,null,1,"https://accounts.google.com/ServiceLogin",null,[],4,[],"GlifWebSignIn",null,[]],10,[null,null,[],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,[5,"77185425430.apps.googleusercontent.com",["https://www.google.com/accounts/OAuthLogin"],null,null,"b60d608e-b343-4382-bf7d-a90394a761fd",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,5,null,null,[],null,null,null,[],[]],null,null,null,null,null,null,[],null,null,null,[],[]],null,null,null,true],"{eml}",null,null,null,true,true,[]]',
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,5,null,null,[],null,null,null,[],[]],null,null,null,null,null,null,[],null,null,null,[],[]],null,null,null,null,2,null,false,null,""]',
      'gmscoreversion': 'undefined',
      'checkConnection': 'youtube:210:0',
      'checkedDomains': 'youtube',
      'pstMsg': '1'}
      go = r.post(url,data=data,headers=headers).text
      if 'null,null,null,null,null,null,null,null,null,"https://accounts.google'in go:
        msGML = f'☑️ email Linked on gmail : \n\t{eml}\n\nThe examination is over 🔘'
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msGML}',reply_markup=bar1)
        return MAIN
      elif 'null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,[]'in go:
        msGML = f'✖️ email Not Linked on gmail : \n\t{eml}\n\nThe examination is over 🔘'
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msGML}',reply_markup=bar1)
        return MAIN
      else:
        msGML = f'✖️ email Not Linked on gmail : \n\t{eml}\n\nThe examination is over 🔘'
      ...
      msGML='an error occurred [GMAIL]\n\nThe examination is over 🔘'
      query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msGML}',reply_markup=bar1)
      return MAIN
def hotmail(update,context):
    global eml,msIN,msic,msTW,msTK,msHOT,msSNP
    query = update.callback_query
    ...
    try:
      ...
      if 'Neither' in html:
            msHOT = f"✖️ email Not Linked on hotmail :\n\t{eml}"
            query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msHOT}',reply_markup=bar1)
            GmlShr(update,context)
      else:
            msHOT = f"☑️ email Linked on hotmail :\n\t{eml}"
            query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msHOT}',reply_markup=bar1)
            GmlShr(update,context)
    except:
      msHOT='an error occurred [hotmail]'
      query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}\n{msHOT}',reply_markup=bar1)
      GmlShr(update,context)
def EMLtiktok(update,context):
    global eml,msIN,msic,msTW,msTK,msSNP
    query = update.callback_query
    msTK = 'Linked to tiktok'
    ...
    try:
      ...
      if '"message":"success"' in r1:
        msTK = f'☑️ email Linked to tiktok :\n\t{eml}'
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}',reply_markup=bar1)
        hotmail(update,context)
      elif '"description":"غير مسجل بعد"' in r1:
        msTK = f'✖️ email Not Linked to tiktok :\n\t{eml}'
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}',reply_markup=bar1)
        hotmail(update,context)
      else:
        msTK = f'✖️ email Not Linked to tiktok :\n\t{eml}'
      ...
      msTK='an error occurred [tiktok]'
      query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}\n{msTK}',reply_markup=bar1)
      hotmail(update,context)
def TWR(update,context):
    global eml,msIN,msic,msTW,msSNP
    query = update.callback_query
    ...
    try:
      ...
      if '"taken":true' in go:
        msTW = f"☑️ email Linked on twitter :\n\t{eml}"
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}',reply_markup=bar1)
        EMLtiktok(update,context)
  
      else:
        msTW = f"✖️ email Not Linked on twitter :\n\t{eml}"
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}',reply_markup=bar1)
        EMLtiktok(update,context)
    except:
      msTW='an error occurred [twitter]'
      query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}\n{msTW}',reply_markup=bar1)
      EMLtiktok(update,context)
def emINS(update,context):
    global eml,msIN,msic,msSNP
    query = update.callback_query
    ...
    try:
      ...
      if '"status":"ok"' in go:
        msIN = f"☑️ email Linked on instagram :\n\t{eml}"
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}',reply_markup=bar1)
        TWR(update,context)
      else:
        msIN = f"✖️ email Not Linked on instagram :\n\t{eml}"
        query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}',reply_markup=bar1)
        TWR(update,context)
    except:
      msIN='an error occurred [twitter]'
      query.edit_message_text(text=f'{msSNP}\n{msic}\n{msIN}',reply_markup=bar1)
      TWR(update,context)
def aple(update,context):
    global eml,msic,msSNP
    query = update.callback_query
    ...
    if go.status_code == 200:
      msic = f'☑️ email Linked on icloud : \n\t{eml}'
      query.edit_message_text(text=f'{msSNP}\n{msic}',reply_markup=bar1)
      emINS(update,context)
    else:
      msic = f'✖️ email Not Linked on icloud : \n\t{eml}'
      query.edit_message_text(text=f'{msSNP}\n{msic}',reply_markup=bar1)
      emINS(update,context)
def SNPEML(update,context):
    ...
    if '"hasSnapchat": true' in go:
      msSNP = f"☑️ email Linked on snapchat :\n\t{eml}"
      query.edit_message_text(text=f"{msSNP}",reply_markup=bar1)
      aple(update,context)
    else:
      msSNP = f"✖️ email Not Linked on snapchat :\n\t{eml}"
      query.edit_message_text(text=f"{msSNP}",reply_markup=bar1)
      aple(update,context)
def tellm(update,context):
    ...
    SEARCH ENDED 🔘
        ...
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred\n\nSEARCH ENDED 🔘", reply_markup=bar1)
def disqus(update,context):
    ...
    try:
        ...
        query.edit_message_text(text="🔘 Sorry, a sudden error occurred",reply_markup=bar1)
        tellm(update, context)
...
def teleg(update,context  ):
    ...
    if user == "":
        ...
        return  MAIN
def teleg2(update, context):
    global eml
    eml = ' '.join(context.args)
    Keyboard = [
        [InlineKeyboardButton("Yes", callback_data=str(rde2))],
        [InlineKeyboardButton("GO BACK", callback_data=str(b7s))]]
    okr = InlineKeyboardMarkup(Keyboard)
    if eml == "":
...
def trgm(update: Update, context: CallbackContext) -> None:
    query = update.callback_query
    query.bot.send_sticker(chat_id=query.message.chat_id,sticker='https://t.me/vv3ck/2')
...
Then click here  >>  /start  
                    """
                Keyboard = [
                    [InlineKeyboardButton("Bot channel 🖤", url="https://t.me/vv1ck")]]
                reply_markup = InlineKeyboardMarkup(Keyboard)
                context.bot.send_message(user_id, f"{ms}",reply_markup=reply_markup)
            else:
                if IDadmin in useID:
                    msg = "اهلا مطوري انا تحت الخدمه (:"
                    Keyboard = [
...
def main() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            MAIN: [
                ...
                CallbackQueryHandler(SNPEML, pattern='^' + str(rde2) + '$', run_async=True),
    ...
    dp.add_handler(io)
    esl = CommandHandler('email', teleg2, run_async=True)
    dp.add_handler(esl)
